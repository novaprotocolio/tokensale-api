                        ...
                        helpers.findOneUpdateOrInsert(res, User, constants.USER_MODEL_NAME,
                            ...
                            function (updatedUser) {
                                ...
                                helpers.sendHtmlMail(
                                    ...
                                    updatedUser.email, 'Login Email - Nova Token Sale', BASE_PATH + '/views/emails/verifyEmailOtp.hbs'
                                );
                            ...
                            newUser.save(function (err, newUser) {
                                if (err) {
                                    ...
                                    helpers.sendHtmlMail(
                                        ...
                                        newUser.email, 'Verify Email - NovaTokensale', BASE_PATH + '/views/emails/verifyEmailOtp.hbs');
                            ...
                            helpers.findOneUpdateOrInsert(res, User, constants.USER_MODEL_NAME,
                                ...
                                function(user) {
                                    ...
                                    helpers.sendHtmlMail(
                                        ...
                                        user.email, 'Verify Email - NovaTokenSale', BASE_PATH + '/views/emails/verifyEmailOtp.hbs'
                                    );
