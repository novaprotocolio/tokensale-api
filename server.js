...
config = module.exports = require('./config/env'); // get our config file
constants = module.exports = require('./app/utils/common/constants'); // get our constants file
messages = module.exports = require('./app/utils/common/message.js'); // get messages
helpers = module.exports = require('./app/utils/common/helper.js'); // response
validatorClass = module.exports = require('./app/utils/common/validator.js'); //validator
customValidator = module.exports = require('./app/utils/common/customValidator'); //custom validator
cors = module.exports = require('./app/utils/common/cors'); //cors validator
...
mongoose.connect(conn_string, { useMongoClient: true });

/* END MONGOOSE CONFIGURATION */

var publicRoutes = require('./routes/index.js');
var icoRoutes = require('./app/components/Ico/IcoRoute');
var userRoutes = require('./app/components/User/UserRoute');
var transactionRoutes = require('./app/components/Transaction/TransactionRoute');
var refercodeRoutes = require('./app/components/Refercode/RefercodeRoute');

app.use(
  '/api/transaction',
  validatorClass.useJWTMiddleware(),
  transactionRoutes
); //transaction routes
...
if (process.env.WEB_ASSETS) {
  app.use('/', express.static(process.env.WEB_ASSETS));
} else {
  // //welcome message
  app.get('/', function(req, res, next) {
    res.send('Welcome to Nova Token Sale Dashboard API');
  });
}
